...
from memas_sdk import api_client, exceptions
...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["namespace_pathname", "corpus_pathname", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["namespace_pathname", "corpus_pathname", ], str]):
...
SchemaFor400ResponseBodyApplicationJson = NamespaceDoesNotExistError
...
class DeleteCorpus(BaseApi):
    ...
    def delete_corpus(
        ...
        return self._delete_corpus_oapg(
            body=body,
